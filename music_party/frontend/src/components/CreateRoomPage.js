...
render(){
        ...
        <Grid item xs={12} align='center'>
            <Collapse in={this.state.errorMsg != "" || this.state.successMsg != ""}>
                {this.state.successMsg != "" ? (<Alert severity='success' onClose={()=>{this.setState({
                    successMsg: ""
                });}}>this.state.successMsg</Alert>) : (<Alert severity='error' onClose={()=>{this.setState({
                    errorMsg: ""
    ...
    ); //1 means 8 pixels grid spacing, upper level is always a container...then we add items on to it
